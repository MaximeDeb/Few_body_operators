...
filename = "C:/Users/maxim/Documents/GitHub/Few_body_operators/Plots/Compressed_U/IRLM_U_L20_dt0.01_alpha-1_Truncationglobal_chi1024_Sect20_TrottOrder4_Nsteps151_phys_dims1_d2_Uint0.2_V0.2_gamma0.5_ed0_J0_Jz0.h5"
...
for i in range(3):
    ...
    y = BondDim[i]
    figures_module.plot1d(ax, x, y, color=mpl.colormaps["Blues"](shade), marker=m[i], markersize=1., lw=0.3, label='$t=%s$'%(np.round(Time[i],3)+0.01))
...
ax.set_xlabel(r"Orbital index $n$")
ax.set_ylabel(r"$\chi_n^{}$")

namefile='C:/Users/maxim/Documents/GitHub/Few_body_operators/Plots/Compressed_U/Compression_U.pdf'
